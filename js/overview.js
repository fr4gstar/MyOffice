jQuery(document).ready(function(){
  ...
  /*jQuery.get("contacts.php",{},function(data){
        ...
        while(json[counter]){
          jQuery("#contactTable").append(
            "<tr id='row_editContact"+json[counter][counter][0]+"'></td><td><button id='btn_viewContact"+json[counter][counter][0]+"'>*</button><button id='btn_deleteContact"+json[counter][counter][0]+"'>-</button><button id='btn_editContact"+json[counter][counter][0]+"'>/</button><td>"+json[counter][counter][1]+"</td><td>"+json[counter][counter][2]+"</td><td>"+json[counter][counter][3]+"</td><tr>"
          );
