<?php
  ...
  if(isset($_SESSION['login']) == false){
    die("Du bist nicht eingeloggt");
      ...
      if(isset($_GET['cid'] AND $_GET['firstname']) AND isset($_GET['lastname']) AND isset($_GET['firm']) AND isset($_GET['email']) AND isset($_GET['tel']) AND isset($_GET['note']) OR (strlen($_GET['firstname']) > 0) OR (strlen($_GET['lastname']) > 0) OR (strlen($_GET['firm']) > 0) OR (strlen($_GET['email']) > 0) OR (strlen($_GET['tel']) > 0)) {
